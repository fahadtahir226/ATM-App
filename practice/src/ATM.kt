...
fun add(){
    ...
    val accountNameforquestion:String = readLine()!!
    println("Enter Password:")
    accounts.add(Account(accountNameforquestion,readLine()!!))
    mainMenu()
}
    ...
    for(i in accounts){
        ...
        if(i.accountName==loginAccount){
            if(i.accountPin==loginPass){
                println("Welcome $loginAccount $\n  currently your account have ${i.accountInitialDepositAmount}")
